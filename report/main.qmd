...
```{r missing-data-plot, fig.height=3, fig.cap= "The proportion of missing values for all columns in the dataset."}
...
\
```{r time-series-plot, fig.height=3, fig.width=6, fig.cap= "Daily percentage of zero-calorie beverages sales over time for each of the three sites."}
...
```{r boxplot, fig.height=3, fig.width=6, fig.cap= "Boxplots of daily percentage of zero-calorie beverages sales for each of the three sites."}
