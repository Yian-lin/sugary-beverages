...
### Results analysis
By fitting the negative binomial GLMM for daily count of zero-calorie beverages, the estimated fixed effect coefficients are shown in table \ref{tab3}. 
```{=tex}
\begin{table}[htbp]
\centering
